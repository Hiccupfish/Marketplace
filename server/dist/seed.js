...
async function main() {
    ...
    if (requesters.length === 0) {
        const sampleUsers = [
            { email: 'alice@example.co.za', name: 'Alice M', password: await (0, hash_1.hashPassword)('Password123!'), phoneNumber: '+27 71 111 1111', location: 'Johannesburg, Gauteng, South Africa' },
            { email: 'bob@example.co.za', name: 'Bob T', password: await (0, hash_1.hashPassword)('Password123!'), phoneNumber: '+27 72 222 2222', location: 'Cape Town, Western Cape, South Africa' },
            { email: 'carol@example.co.za', name: 'Carol N', password: await (0, hash_1.hashPassword)('Password123!'), phoneNumber: '+27 73 333 3333', location: 'Durban, KwaZulu-Natal, South Africa' }
        ];
        requesters = [];
    ...
    const makeId = (title, requesterId) => {
